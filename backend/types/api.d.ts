...
declare namespace Paths {
    ...
    namespace PostAssetsHandler {
        export type RequestBody = /* Schema defining the request payload for uploading assets. Requires a list of files to upload. */ Components.Schemas.UploadAssetRequest;
        namespace Responses {
            export type $202 = /* Schema defining the response for a successful asset upload operation. Contains identifiers for all uploaded assets. */ Components.Schemas.UploadAssetResponse;
