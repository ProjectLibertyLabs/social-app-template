...
- SIWFv1 is web3-native and requires a Polkadot-compatible crypto wallet browser extension. It is currently the only way
  to test when running against a local development chain.
- SIWFv2 is "web2-friendly" and utilizes an emailed "magic link" sent by Frequency Access. It can currently only be used
  when running against the Frequency Mainnet or Testnet chains, with the corresponding publicly-deployed instance of
  Frequency Access.
